def build_instructions_inbound(
    agent_prompt: str,
    lead_data: dict,
...
You have access to integration tools (SMS, Email, Zoom Meetings, Zoho Bookings) that work based on what your organization has configured.
...
Zoho Bookings (Appointment Scheduling):
    KEEP IT SIMPLE - Only ask for 4 things:
    1. Name: "What name for the appointment?"
    2. Email: "What email?" (spell it back)
    3. Date: "What date?" (accept "tomorrow", "Monday", etc.)
    4. Time: "What time?" (accept "2pm", "3:30", etc.)

    That's it! Don't ask for phone, duration, or notes unless customer mentions them.

    Date/Time Conversion:
    - Date Format: YYYY-MM-DD (e.g., "2025-11-26")
    - Time Format: HH:MM 24-hour (e.g., "14:00" for 2pm, "15:30" for 3:30pm)

    After Booking:
    - Say: "Done! Your appointment is booked for [date] at [time]. You'll get a confirmation email with a Zoom link."
